...
public class CosUploadController {
    private static Logger logger = LoggerFactory.getLogger(CosUploadController.class);
...
//        }
//        return "上传成功";
        return upload(multipartFile,"/dir5");
    }
        ...
        try {
            ...
            if (1 == fileNumber) {
                ...
                MultipartBody multipartBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                        ...
                        .addFormDataPart("encryptMode","normal")
                    ...
                    if (i != fileNumber - 1) {
                        ...
                        if (i == 0) {
                            ...
                            MultipartBody multipartBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                                    ...
                                    .addFormDataPart("encryptMode","normal").build();
